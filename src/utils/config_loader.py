...
ALL_SETTINGS = [
    ...
    'SUGGESTIONS_AUTO_SCAN_MINUTES', 'SUGGESTIONS_FULL_REFRESH_DAY', 'SUGGESTIONS_FULL_REFRESH_TIME',
...
DEFAULT_CONFIG = {
    ...
    'KOSYNC_CREDENTIALS_FROM_GRIMMORY': 'false',
    ...
    'BOOKLORE_SHELF_REQUIRE_ALIGNMENT': 'false',
